...
export default function FaithStoryPage() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <p>
              ...
              her to earn a doctorate degree—a testament to her unwavering
              spirit.
            </p>
            ...
            <p>
              ...
              projects program, where she interviewed her grandmothers.
              Reflecting on the experience, she wrote, “If we overlook the
              stories and emotions of everyday people, the true essence of
            ...
            <p>
              ...
              struggles, triumphs, and dreams of generations, and they deserve
              to be remembered.
            </p>

            <p>
              And so, Family Stories was born—a project dedicated to recording
              and celebrating the lives of everyday families, ensuring their
              voices are heard and their legacies endure.
            </p>

            <p>
              Our vision is for this to become a space where family stories are
              not only preserved but also evolve. As one family member
              interviews another, more relatives may join in, creating a ripple
              effect of storytelling. In this way, a rich and vibrant tapestry
              of their family history will be woven together.
            </p>
            ...
            <p className="text-xl font-medium text-amber-700 italic">
              ...
              family—particularly the interviewee—retains control over who,
              aside from EEF staff, can access the files and under what
              circumstances.
            </p>
          </motion.div>
